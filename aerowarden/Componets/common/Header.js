...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-20 border-b border-slate-200 bg-slate-200/90 backdrop-blur-xl shadow-xl p-2">
                    ...
                    {session ? (
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="rounded-full bg-slate-900 px-5 py-2 textlg font-semibold text-white transition hover:bg-slate-800 disabled:opacity-70"
                            >
                                {status ===
                                    "loading"
                                    ? "Cargando..."
